...
for cohorte in dates:
    ...
    df=pd.read_parquet(path+"/Prepro/prepro_data_"+cohorte+".parquet",engine='pyarrow')
    ...
    for var in var_quel:
        ...
        dml_irm_obj = dml.DoubleMLIRM(obj_dml_data, ml_g, ml_m,score="ATTE")


        
        dml_irm_obj.fit()

        joblib.dump(dml_irm_obj, path+"/Résultats/Python/IRM/ATT/dml_irm_att_"+cohorte+"_"+var+".joblib")
